...
- Raw captures: `legacy/source-material/expansion-2026-05-18/ai-slop/raw/`
- Derived candidates: `legacy/source-material/expansion-2026-05-18/ai-slop/derived/`
- Download notes: `legacy/source-material/expansion-2026-05-18/ai-slop/raw/download-notes.md`
...
- Not downloaded:
  ...
  - Auto-Antislop `slop-forensics` submodule. Existing repo already has `legacy/source-material/llm-slop-lists/slop-forensics/`.
...
- Auto-Antislop `slop-forensics` was not copied from the submodule because equivalent prior material already exists under `legacy/source-material/llm-slop-lists/slop-forensics/`.
